...
texto('Descripción: Como usuario, quiero poder personalizar los mapas interactivos con mis propios puntos', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;de interés, para adaptar el mapa a mis necesidades.', 5, 'white')  
...
texto('Descripción: Como usuario, quiero filtrar los puntos de interés en el mapa por categorías,', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;para encontrar rápidamente lo que me interesa.', 5, 'white')  
texto('Criterios de Aceptación:', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Debe haber opciones de filtro por categorías (ej. restaurantes, museos, tiendas).', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Al seleccionar una categoría, el mapa debe actualizarse para mostrar solo los puntos', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;de interés correspondientes.', 5, 'white')
texto('Prioridad: 3 ', 5, 'white')  
texto('Fecha estimada de entrega: 23/08/2024', 5, 'white')

st.markdown("""<hr style="height:10px;border:none;color:#333;background-color:#3ebc32;" /> """, unsafe_allow_html=True)
texto('Historia 3 - Integración con el Sistema de Reservas', 4, 'yellow')
texto('Descripción: Como usuario, quiero poder reservar experiencias únicas desde la misma plataforma ', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;donde reservé mi alojamiento.', 5, 'white')
texto('Criterios de Aceptación:', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Los usuarios deben poder seleccionar y reservar experiencias desde la página del alojamiento.', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- La reserva de la experiencia debe estar vinculada a la reserva del alojamiento.', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Debe haber confirmación y detalles de la reserva de la experiencia.', 5, 'white')
texto('Prioridad: 5 ', 5, 'white')  
texto('Fecha estimada de entrega: 23/08/2024', 5, 'white')

st.markdown("""<hr style="height:10px;border:none;color:#333;background-color:#3ebc32;" /> """, unsafe_allow_html=True)
texto('Historia 4 - Sección de Opiniones de Experiencias', 4, 'yellow')
texto('Descripción: Como usuario, quiero leer opiniones de otras personas sobre las experiencias disponibles,', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; para tomar una decisión informada.', 5, 'white') 
texto('Criterios de Aceptación:', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Debe haber una sección de opiniones en la página de cada experiencia.', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Los usuarios deben poder calificar y escribir reseñas de las experiencias.', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Las opiniones deben ser visibles para todos los usuarios.', 5, 'white')
texto('Prioridad: 2 ', 5, 'white')  
texto('Fecha estimada de entrega: 23/08/2024', 5, 'white')
  
st.markdown("""<hr style="height:10px;border:none;color:#333;background-color:#3ebc32;" /> """, unsafe_allow_html=True)
texto('Historia 5 - Notificaciones de Reservas de Experiencias', 4, 'yellow')
texto('Descripción: Como usuario, quiero recibir notificaciones cuando se confirma una reserva de una ', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;experiencia, para estar informado', 5, 'white')
texto('Criterios de Aceptación:', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Los usuarios deben recibir notificaciones por email y en la app cuando una reserva de', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;experiencia se confirme.', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Las notificaciones deben incluir detalles de la reserva.', 5, 'white')
...
texto('Descripción: Como usuario, quiero ver mapas interactivos que muestran puntos de interés', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cercanos a mi alojamiento, para planificar mejor mi viaje.', 5, 'white') 
texto('Criterios de Aceptación:', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- El mapa interactivo debe estar disponible en la página de detalles del alojamiento.', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- El mapa debe mostrar puntos de interés como restaurantes, museos, tiendas, etc.', 5, 'white')
texto('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Los puntos de interés deben ser clicables y mostrar información adicional.', 5, 'white')
texto('Prioridad: 3 ', 5, 'white')  
